...
def ResNet101(weight_file=None, inputs=None, use_global=False, weight_decay=None):
    ...
    res3b1_branch2c = convolution(res3b1_branch2b_relu, group=1, strides=[1, 1], padding='VALID',
    ...
    res3b2_branch2c = convolution(res3b2_branch2b_relu, group=1, strides=[1, 1], padding='VALID',
    ...
    res3b3_branch2c = convolution(res3b3_branch2b_relu, group=1, strides=[1, 1], padding='VALID',
    ...
    res4b1_branch2c = convolution(res4b1_branch2b_relu, group=1, strides=[1, 1], padding='VALID',
    ...
    res4b2_branch2c = convolution(res4b2_branch2b_relu, group=1, strides=[1, 1], padding='VALID',
    ...
    res4b3_branch2c = convolution(res4b3_branch2b_relu, group=1, strides=[1, 1], padding='VALID',
    ...
    res4b4_branch2c = convolution(res4b4_branch2b_relu, group=1, strides=[1, 1], padding='VALID',
    ...
    res4b5_branch2c = convolution(res4b5_branch2b_relu, group=1, strides=[1, 1], padding='VALID',
    ...
    res4b6_branch2c = convolution(res4b6_branch2b_relu, group=1, strides=[1, 1], padding='VALID',
    ...
    res4b7_branch2c = convolution(res4b7_branch2b_relu, group=1, strides=[1, 1], padding='VALID',
    ...
    res4b8_branch2c = convolution(res4b8_branch2b_relu, group=1, strides=[1, 1], padding='VALID',
    ...
    res4b9_branch2c = convolution(res4b9_branch2b_relu, group=1, strides=[1, 1], padding='VALID',
    ...
    res4b10_branch2b = convolution(res4b10_branch2b_pad, group=1, strides=[1, 1], padding='VALID',
    ...
    res4b10_branch2c = convolution(res4b10_branch2b_relu, group=1, strides=[1, 1], padding='VALID',
    ...
    res4b11_branch2b = convolution(res4b11_branch2b_pad, group=1, strides=[1, 1], padding='VALID',
    ...
    res4b11_branch2c = convolution(res4b11_branch2b_relu, group=1, strides=[1, 1], padding='VALID',
    ...
    res4b12_branch2b = convolution(res4b12_branch2b_pad, group=1, strides=[1, 1], padding='VALID',
    ...
    res4b12_branch2c = convolution(res4b12_branch2b_relu, group=1, strides=[1, 1], padding='VALID',
    ...
    res4b13_branch2b = convolution(res4b13_branch2b_pad, group=1, strides=[1, 1], padding='VALID',
    ...
    res4b13_branch2c = convolution(res4b13_branch2b_relu, group=1, strides=[1, 1], padding='VALID',
    ...
    res4b14_branch2b = convolution(res4b14_branch2b_pad, group=1, strides=[1, 1], padding='VALID',
    ...
    res4b14_branch2c = convolution(res4b14_branch2b_relu, group=1, strides=[1, 1], padding='VALID',
    ...
    res4b15_branch2b = convolution(res4b15_branch2b_pad, group=1, strides=[1, 1], padding='VALID',
    ...
    res4b15_branch2c = convolution(res4b15_branch2b_relu, group=1, strides=[1, 1], padding='VALID',
    ...
    res4b16_branch2b = convolution(res4b16_branch2b_pad, group=1, strides=[1, 1], padding='VALID',
    ...
    res4b16_branch2c = convolution(res4b16_branch2b_relu, group=1, strides=[1, 1], padding='VALID',
    ...
    res4b17_branch2b = convolution(res4b17_branch2b_pad, group=1, strides=[1, 1], padding='VALID',
    ...
    res4b17_branch2c = convolution(res4b17_branch2b_relu, group=1, strides=[1, 1], padding='VALID',
    ...
    res4b18_branch2b = convolution(res4b18_branch2b_pad, group=1, strides=[1, 1], padding='VALID',
    ...
    res4b18_branch2c = convolution(res4b18_branch2b_relu, group=1, strides=[1, 1], padding='VALID',
    ...
    res4b19_branch2b = convolution(res4b19_branch2b_pad, group=1, strides=[1, 1], padding='VALID',
    ...
    res4b19_branch2c = convolution(res4b19_branch2b_relu, group=1, strides=[1, 1], padding='VALID',
    ...
    res4b20_branch2b = convolution(res4b20_branch2b_pad, group=1, strides=[1, 1], padding='VALID',
    ...
    res4b20_branch2c = convolution(res4b20_branch2b_relu, group=1, strides=[1, 1], padding='VALID',
    ...
    res4b21_branch2b = convolution(res4b21_branch2b_pad, group=1, strides=[1, 1], padding='VALID',
    ...
    res4b21_branch2c = convolution(res4b21_branch2b_relu, group=1, strides=[1, 1], padding='VALID',
    ...
    res4b22_branch2b = convolution(res4b22_branch2b_pad, group=1, strides=[1, 1], padding='VALID',
    ...
    res4b22_branch2c = convolution(res4b22_branch2b_relu, group=1, strides=[1, 1], padding='VALID',
    ...
    with tf.variable_scope('feature') as scope:
        wts = _variable_with_weight_decay_and_constant_value('weight', __weights_dict['feature_1']['weights'],
                                                             weight_decay)
...
def batch_normalization(input, name, **kwargs):
    ...
    with tf.variable_scope(name):
        ...
        offset = _variable_on_cpu_with_constant_value('bias', __weights_dict[name]['bias']) if 'bias' in __weights_dict[
            name] else None
        scale = _variable_on_cpu_with_constant_value('scale', __weights_dict[name]['scale']) if 'scale' in \
                                                                                                __weights_dict[
                                                                                                    name] else None
